...
export default function DashProfile() {
    ...
    const uploadImage = async ()=>{
        ...
        uploadTask.on('state_changed',(snapshot)=>{
            ...
            setImageFileUploadError('không thể tải hình ảnh lên(tập tin phải nhỏ hơn 2MB)')
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
        ...
        <form className='flex flex-col gap-4'>
            ...
            <TextInput type='text' id='username' placeholder='Tên người dùng' defaultValue={currentUser.username}/>
